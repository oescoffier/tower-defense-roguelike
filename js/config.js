...
export const COMMANDERS = {
  cmdr_fury: {
    ...
    targets: TARGET.BOTH, damage: 32, rate: 16, range: 2, projSpeed: 36, spinMax: 3.4, spinUp: 0.5, spinDown: 0.3,
  ...
  cmdr_leadstorm: {
    ...
    targets: TARGET.BOTH, damage: 24, rate: 22, range: 2, projSpeed: 42, spinMax: 2.6, spinUp: 0.8, spinDown: 0.6,
  ...
  cmdr_bastion: {
    ...
    targets: TARGET.BOTH, damage: 48, rate: 12, range: 2, projSpeed: 30, spinMax: 2.0, spinUp: 1.0, spinDown: 1.0,
  ...
  cmdr_ghost: {
    ...
    targets: TARGET.BOTH, damage: 900, rate: 1.4, range: 4, pierce: 6, critChance: 0.35, critMult: 4,
  ...
  cmdr_vengeance: {
    ...
    targets: TARGET.BOTH, damage: 1100, rate: 0.8, range: 4, pierce: 8, critChance: 0.2, critMult: 5,
  ...
  cmdr_heavyarty: {
    ...
    targets: TARGET.GROUND, damage: 260, rate: 1.0, range: 5, minRange: 2, splash: 3.2, arcTime: 0.6,
  ...
  cmdr_scorchedearth: {
    ...
    targets: TARGET.GROUND, damage: 180, rate: 1.3, range: 5, minRange: 2, splash: 2.6, arcTime: 0.55,
  ...
  cmdr_earthquake: {
    ...
    targets: TARGET.GROUND, damage: 220, rate: 0.9, range: 5, minRange: 2, splash: 3.6, arcTime: 0.7,
  ...
  cmdr_lightning: {
    ...
    targets: TARGET.BOTH, damage: 90, rate: 2.6, range: 2, bounces: 14, bounceFalloff: 0.94, bounceRange: 4.5, chargeDur: 6, chainBlast: 1.0,
  ...
  cmdr_overvolt: {
    ...
    targets: TARGET.BOTH, damage: 130, rate: 2.0, range: 2, bounces: 8, bounceFalloff: 0.9, bounceRange: 3.6, chargeDur: 5, chainBlast: 1.4,
  ...
  cmdr_reactor: {
    ...
    targets: TARGET.BOTH, damage: 70, rate: 3.2, range: 2, bounces: 10, bounceFalloff: 0.92, bounceRange: 4.0, chargeDur: 6, chainBlast: 0.8,
  ...
  cmdr_endlessstorm: {
    ...
    targets: TARGET.BOTH, damage: 100, rate: 2.2, range: 2, bounces: 12, bounceFalloff: 0.93, bounceRange: 4.2, chargeDur: 7, chainBlast: 1.2,
  ...
  cmdr_inferno: {
    ...
    targets: TARGET.GROUND, damage: 55, rate: 9, range: 1, cone: 110, burnDps: 40, burnDur: 6, burnStacks: 12,
  ...
  cmdr_dragon: {
    ...
    targets: TARGET.GROUND, damage: 45, rate: 8, range: 1, cone: 90, burnDps: 30, burnDur: 5, burnStacks: 10,
  ...
  cmdr_combustion: {
    ...
    targets: TARGET.GROUND, damage: 60, rate: 7, range: 1, cone: 80, burnDps: 45, burnDur: 5, burnStacks: 8,
  ...
  cmdr_totalflak: {
    ...
    targets: TARGET.AIR, damage: 380, rate: 2.0, range: 3, missiles: 5, missileSpeed: 20, turnRate: 9, flakSplash: 2.2,
  ...
  cmdr_sentinel: {
    ...
    targets: TARGET.AIR, damage: 450, rate: 1.6, range: 3, missiles: 3, missileSpeed: 18, turnRate: 8, flakSplash: 1.8,
...
export const ENEMIES = {
  ...
  ram: {
    ...
    gold: 26, leak: 3, radius: 16, color: '#8b1e1e', shape: 'hex',
    // siege : ignore le flow field. Fonce en ligne la plus directe possible
    // vers la base, à travers tours ET cailloux, détruisant sans dégâts la
    // première tour qu'il atteint sur chaque case traversée. Doit être
    // abattu EN CHEMIN — une fois au contact d'une tour, c'est trop tard.
    siege: true, unlock: 12
  },
...
export const VARIANTS = {
  ...
  mortar: [
    ...
    },
    {
      ...
      desc: 'Très lente, mais dévastatrice : grosse explosion, puis une zone irradiée qui continue à ronger tout ce qui la traverse.',
      mult: { damage: 2.8, rate: 0.23, splash: 1.4, arcTime: 2.2 },
